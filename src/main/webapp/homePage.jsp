...
<html>
    ...
    <body>
        ...
        <div id="nav">
            <br><input class="myButton" type="submit" value="Upload from file" name="uploadFromFil" >
            <br><br><input class="myButton" type="submit" value="Take Snapshot" name="takeSnapshot" >
